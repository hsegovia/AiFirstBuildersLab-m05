...
/// Identity (FR-04). El mensaje incluye el detalle de las reglas incumplidas (tal como las reporta
/// Identity), pero nunca la contraseña real: es un dato sensible que nunca debe llegar a un log ni
/// a una respuesta HTTP (NFR-02).
/// </summary>
